...
export const conversations = [
  ...
  {id: 2, name:'John Coffee', lastSeen: 'last seen 2 Aug 2016', messages: [
    {from: 0, message: 'Spoon, to go cup cream variety id americano. Macchiato coffee white pumpkin spice percolator at cream.', date: '20:12', info: SENT}]
  },
  ...
  {id: 4, name:'Paul', lastSeen: 'last seen Friday at 22:22', messages: [
    {from: 1, message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', date: '13:37'}]
  },
  {id: 5, name:'Marie', lastSeen: 'last seen yesterday at 12:22', messages: [
    {from: 0, message: 'What\'s up, fizz-ellas. I think I might have someone who\'s going to circumvrent the law. Actually, that was a box of Oscar\'s legally obtained medical marijuana.', date: '11:11', info: READ}]
  },
  {id: 6, name:'Cheese', lastSeen: 'last seen Monday at 12:10', messages: [
    ...
    {from: 1, message: 'Chocolate cake candy canes chupa chups fruitcake topping chocolate bar. Gummi bears chocolate sugar plum gummi bears.', date: '16:44'}]
  },
  {id: 7, name:'Arthur', lastSeen: 'last seen Tuesday at 03:23', messages: [
    {from: 0, message: 'Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.', info: READ, date: '12:55'},
    {from: 1, message: 'Bring to the table win-win survival strategies to ensure proactive domination.', date: '9:59'}]
  },
  {id: 8, name:'Zombie', lastSeen: 'last seen Thursday at 00:21', messages: [
    {from: 0, message: 'Zombie ipsum reversus ab viral inferno, nam rick grimes malum cerebro.', date: '10:00', info: READ},
    {from: 1, message: 'De carne lumbering animata corpora quaeritis.', date: '20:13'}]
  },
]
